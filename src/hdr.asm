...
.SNESHEADER
  ...
  CARTRIDGETYPE $00   ; $00 ROM only, $01 ROM and RAM no sram, $02 ROM and sram. higher than $02 indicates special hardware addon in cartridge, must set rom layout properly, see line 21 and 22
  ; $00 to $0C RAM and ROM size. Values for RAM are $00 (no RAM) to $05 (32KB)
  ; RAM values $06 and $07 are apparently unused but are indicated as 64KB and 128KB respectively
